...
const double _kSplashConfirmedVelocity = 0.0; // logical pixels per millisecond
...
class _InkFadeFactory extends InteractiveInkFeatureFactory {
  const _InkFadeFactory();
...
///    Material widgets.
class InkFade extends InteractiveInkFeature {
  ...
  static const InteractiveInkFeatureFactory splashFactory = _InkFadeFactory();
